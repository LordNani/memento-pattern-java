...
class Canvas extends java.awt.Canvas {
    ...
    public void paint(Graphics graphics) {
        BufferedImage buffer = new BufferedImage(360, 360, BufferedImage.TYPE_INT_RGB);
        Graphics2D ig2 = buffer.createGraphics();
        ig2.setBackground(Color.WHITE);
        ig2.clearRect(0, 0, 360, 360);
        System.out.println("Size of screen is " + this.getWidth() +" " + this.getHeight());
